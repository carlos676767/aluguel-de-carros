...
class Carro {
  ...
  static #path = require("path")
    ...
    static adicionarCarrosDb(modelo, marca,  precoDiaria, IMAGEM, disponibilidade, PLACA, ANO, res ) {
      ...
      const insert = iserirValor.run(modelo,marca,precoDiaria, IMAGEM, disponibilidade, PLACA, ANO )
     ...
     this.#sql.dbQuery().close()
     throw new Error("Ocorreu um erro inesperado ao tentar cadastrar o carro. Por favor, tente novamente mais tarde.")
    }
